...
class FactTableCell: UITableViewCell {
    ...
    private func addConstraint() {
        ...
        let descriptionVerticalConstraint = NSLayoutConstraint.constraints(withVisualFormat: "V:[title]-10-[description]-20-|", options: NSLayoutFormatOptions.directionLeadingToTrailing, metrics: nil, views: views)
